...
class User(UserMixin , db.Model) :
    ...
    liked_posts = db.relationship('Post' , secondary=liked_posts , viewonly=True)
    disliked_posts = db.relationship('Post' , secondary=disliked_posts , viewonly=True)
    saved_posts = db.relationship('Post' , secondary=saved_posts , viewonly=True)
    hidden_posts  = db.relationship('Post' , secondary=hidden_posts , viewonly=True)
    reported_posts  = db.relationship('Post' , secondary=reported_posts , viewonly=True)
